...
describe("AuditService", () => {
  ...
  describe("logLogin", () => {
    it("should log user login with correct parameters", async () => {
    ...
    it("should log user login without optional parameters", async () => {
      await AuditService.logLogin("user-123", "testuser");
  ...
  describe("logLogout", () => {
    it("should log user logout with correct parameters", async () => {
  ...
  describe("logPasswordChange", () => {
    it("should log password change with correct parameters", async () => {
  ...
  describe("logUserCreate", () => {
    it("should log user creation with correct parameters", async () => {
  ...
  describe("logUserUpdate", () => {
    it("should log user update with correct parameters", async () => {
  ...
  describe("logUserDelete", () => {
    it("should log user deletion with correct parameters", async () => {
  ...
  describe("logPasswordReset", () => {
    it("should log password reset with correct parameters", async () => {
