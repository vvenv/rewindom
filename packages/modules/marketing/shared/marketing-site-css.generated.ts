...
.form-field { display: grid; gap: .375rem; min-width: 0; }
.form-field > label { font-size: .875rem; font-weight: 500; }
.form-req { color: var(--accent); margin-left: .125rem; }
.form-field input, .form-field textarea, .form-field select {
  width: 100%; border: 1px solid var(--border); border-radius: var(--radius);
  background: var(--bg); color: inherit; padding: .5rem .75rem; font: inherit;
}
...
.form-check > label { display: flex; align-items: center; gap: .5rem; font-weight: 400; }
.form-check input { width: auto; }
.form-error { color: #dc2626; font-size: .8125rem; }
