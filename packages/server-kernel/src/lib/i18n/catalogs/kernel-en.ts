...
export const KERNEL_MESSAGES_EN: Record<string, string> = {
  ...
  "auth.impersonation_return_missing": "No platform session to restore",
  "auth.2fa_already_enabled": "Two-factor authentication is already enabled",
  "auth.2fa_setup_required": "Start two-factor setup first",
  "auth.2fa_not_enabled": "Two-factor authentication is not enabled",
  "auth.2fa_code_invalid": "Invalid authentication code",
  "auth.2fa_code_required": "Please enter the authentication code",
  "auth.2fa_verify_required": "Challenge token and code are required",
  "auth.2fa_challenge_invalid": "Two-factor challenge expired or invalid",
  ...
  "auth.oauth_not_configured": "Third-party login is not configured",
  "auth.oauth_callback_unconfigured":
    "OAuth callback URL is not configured (set FRONTEND_URL)",
  "auth.oauth_state_invalid":
    "Third-party login state is invalid or expired; please try again",
  "auth.oauth_exchange_failed": "Failed to exchange authorization code",
  "auth.oauth_profile_failed": "Failed to fetch account profile",
  "auth.oauth_denied": "Authorization was cancelled",
  "auth.oauth_failed": "Third-party login failed; please try again",
  "auth.oauth_registration_disabled":
    "Self-registration is closed; ask an admin for an account before using third-party login",
  "auth.oauth_already_linked": "This account is already linked to another user",
  "auth.audit.login_oauth_github": "Signed in with GitHub",
  "auth.audit.login_oauth_google": "Signed in with Google",
  "auth.audit.login_oauth_microsoft": "Signed in with Microsoft",
