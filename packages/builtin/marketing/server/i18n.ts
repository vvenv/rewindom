...
export const MARKETING_SERVER_I18N: ServerI18nBundle = {
  ...
  messages: {
    "zh-CN": {
      ...
      "marketing.audit.asset_updated": "编辑官网媒体信息",
      ...
      "site.page_description_required": "页面描述不能为空",
    ...
    en: {
      ...
      "marketing.audit.asset_updated": "Edited media details",
      ...
      "site.page_description_required": "Page description is required",
