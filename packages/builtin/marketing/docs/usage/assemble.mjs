 ...
 * 那时任何相对 `fs` 读都会落到 `apps/server/docs/usage` 这个不存在的路径上——首次启动
 * （库里还没有已发布文档）直接 ENOENT，bootstrap `process.exit(1)`。所以内容必须
 * 在构建期内联进 bundle，与 `marketing-site-css.generated.ts` 同一手法。
 *
 *   node packages/builtin/marketing/docs/usage/assemble.mjs
 */
