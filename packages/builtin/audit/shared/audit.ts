...
export const AuditAction = {
  ...
  IP_RULE_CREATE: "IP_RULE_CREATE",
  IP_RULE_UPDATE: "IP_RULE_UPDATE",
  IP_RULE_DELETE: "IP_RULE_DELETE",
  IP_RULE_EXPORT: "IP_RULE_EXPORT",
  ...
  SITE_ASSET_UPLOAD: "SITE_ASSET_UPLOAD",
  SITE_ASSET_REPLACE: "SITE_ASSET_REPLACE",
  SITE_ASSET_UPDATE: "SITE_ASSET_UPDATE",
...
export const AUDIT_ACTION_LABELS: Record<AuditActionType, string> = {
  ...
  [AuditAction.IP_RULE_CREATE]: "新增访问规则",
  [AuditAction.IP_RULE_UPDATE]: "更新访问规则",
  [AuditAction.IP_RULE_DELETE]: "删除访问规则",
  [AuditAction.IP_RULE_EXPORT]: "导出边缘层封禁名单",
  ...
  [AuditAction.SITE_ASSET_UPLOAD]: "上传官网媒体",
  [AuditAction.SITE_ASSET_REPLACE]: "替换官网媒体",
  [AuditAction.SITE_ASSET_UPDATE]: "编辑官网媒体信息",
...
export const AUDIT_ACTION_GROUPS = [
  ...
  },
  {
    label: "访问控制",
    actions: [
      AuditAction.IP_RULE_CREATE,
      AuditAction.IP_RULE_UPDATE,
      AuditAction.IP_RULE_DELETE,
      AuditAction.IP_RULE_EXPORT,
    ],
  },
  {
    label: "示例模块",
  ...
  },
  {
    ...
    actions: [
      ...
      AuditAction.SITE_ASSET_UPLOAD,
      AuditAction.SITE_ASSET_REPLACE,
      AuditAction.SITE_ASSET_UPDATE,
