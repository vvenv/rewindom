...
/** 本地测试 i18n bundle——不依赖其它模块，避免 internal → external 依赖 */
const TEST_I18N_BUNDLE: ServerI18nBundle = {
  id: "test-audit",
  messages: {
    "zh-CN": {
...
describe("AuditService", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    resetServerI18nCatalogsForTests();
    registerServerI18nBundles([TEST_I18N_BUNDLE]);
  });
