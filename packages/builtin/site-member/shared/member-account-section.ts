...
export const memberAccountPanelSection: SectionDefinition = {
  ...
  settings: [
    ...
    { type: "header", content: "site-member:section.account.profile" },
    {
      ...
      default: "site-member:account.profile_title",
    },
    {
      type: "text",
      id: "profile_desc",
      label: "site-member:section.account.profileDesc",
      default: "site-member:account.profile_desc",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      default: "site-member:account.save",
      required: true,
    },
    {
      type: "checkbox",
    ...
    },
    {
      ...
      default: "site-member:account.created_at",
    },
    {
      type: "text",
      id: "last_login_label",
      label: "site-member:section.account.lastLoginLabel",
      default: "site-member:account.last_login_at",
    },
    ...
    },
    {
      ...
      default: "site-member:account.password_title",
    },
    {
      type: "text",
      id: "password_desc",
      label: "site-member:section.account.passwordDesc",
      default: "site-member:account.password_desc",
    },
    {
      type: "text",
      id: "old_password_label",
      label: "site-member:section.account.oldPasswordLabel",
      default: "site-member:fields.old_password",
      required: true,
    },
    {
      type: "text",
      ...
      default: "site-member:fields.new_password",
      required: true,
    },
    {
      type: "text",
      ...
      default: "site-member:fields.confirm_password",
      required: true,
    },
    {
      type: "text",
    ...
    { type: "header", content: "site-member:section.account.session" },
    {
      ...
      default: "site-member:account.logout",
      required: true,
    },
    ...memberCardSettings(),
    ...memberPageLayoutSettings(),
