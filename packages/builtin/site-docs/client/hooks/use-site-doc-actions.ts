...
export interface SiteDocActions {
  togglePublish: (doc: SiteDocListItem) => Promise<void>;
  revert: (doc: SiteDocListItem) => Promise<void>;
  remove: (doc: SiteDocListItem) => Promise<void>;
  exportOne: (doc: SiteDocListItem) => Promise<void>;
