...
import { SitePublishStatus } from "../../../marketing/client/components/SitePublishStatus.js";
...
function DocRowActions({
  ...
  onEdit: (doc: SiteDocListItem) => void;
}): ReactElement {
...
function buildColumns(
  ...
  actions: SiteDocActions,
  onEdit: (doc: SiteDocListItem) => void,
): ColumnDef<DataTableFeatures, SiteDocListItem>[] {
  return [
    {
      accessorKey: "title",
      header: ({ column }) => (
    ...
    */
    ...(showLocale
      ? [
          ...
          } satisfies ColumnDef<DataTableFeatures, SiteDocListItem>,
        ]
      : []),
    {
      accessorKey: "status",
...
export function SiteDocsTable({
  ...
  const { t, i18n } = useTranslation("site-docs");
