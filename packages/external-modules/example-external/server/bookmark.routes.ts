...
export async function bookmarkRoutes(app: FastifyInstance): Promise<void> {
  defineRoute(app, {
    method: "GET",
    url: "/",
    context: "ExternalBookmarkList",
    errorCode: "EXTERNAL_BOOKMARK_LIST_FAILED",
    preHandler: [app.requirePermission("example-external.read")],
  ...
  defineRoute(app, {
    method: "GET",
    url: "/:bookmark_id",
    context: "ExternalBookmarkDetail",
    errorCode: "EXTERNAL_BOOKMARK_DETAIL_FAILED",
    preHandler: [app.requirePermission("example-external.read")],
  ...
  defineRoute(app, {
    method: "POST",
    url: "/",
    context: "ExternalBookmarkCreate",
    errorCode: "EXTERNAL_BOOKMARK_CREATE_FAILED",
    preHandler: [app.requirePermission("example-external.write")],
    handler: async (request, reply) => {
      try {
        ...
        await emitAuditLogFromRequestSafe(app.events, app.log, request, {
          ...
          action: "EXTERNAL_BOOKMARK_CREATE",
          resource: bookmark.id,
          detail_key: "example-external.audit.created",
  ...
  defineRoute(app, {
    method: "PATCH",
    url: "/:bookmark_id",
    context: "ExternalBookmarkUpdate",
    errorCode: "EXTERNAL_BOOKMARK_UPDATE_FAILED",
    preHandler: [app.requirePermission("example-external.write")],
    handler: async (request, reply) => {
      try {
        const { bookmark_id } = request.params as { bookmark_id: string };
        ...
        await emitAuditLogFromRequestSafe(app.events, app.log, request, {
          userId: request.authUser!.userId,
          username: request.authUser!.username,
          action: "EXTERNAL_BOOKMARK_UPDATE",
          resource: bookmark.id,
          detail_key: "example-external.audit.updated",
          detail_params: { title: bookmark.title },
        });
  ...
  defineRoute(app, {
    method: "DELETE",
    url: "/:bookmark_id",
    context: "ExternalBookmarkDelete",
    errorCode: "EXTERNAL_BOOKMARK_DELETE_FAILED",
    preHandler: [app.requirePermission("example-external.write")],
    handler: async (request, reply) => {
      try {
        const { bookmark_id } = request.params as { bookmark_id: string };
        ...
        await emitAuditLogFromRequestSafe(app.events, app.log, request, {
          userId: request.authUser!.userId,
          username: request.authUser!.username,
          action: "EXTERNAL_BOOKMARK_DELETE",
          resource: existing.id,
          detail_key: "example-external.audit.deleted",
