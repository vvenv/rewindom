      ...
      settings: [
        {
          ...
          default: "shop:storefront.product.variant",
          required: true,
        },
        {
          type: "text",
          ...
          default: "shop:storefront.product.quantity",
          required: true,
        },
        {
          type: "text",
          ...
          default: "shop:storefront.product.add",
          required: true,
        },
        {
          type: "text",
          ...
          default: "shop:storefront.product.soldOut",
        },
      ],
    },
  ],
