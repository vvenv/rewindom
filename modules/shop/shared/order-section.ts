...
export const orderSection: SectionDefinition = {
  ...
  settings: [
    ...headingSettings(),
    {
      ...
      default: "shop:storefront.order.status",
    },
    {
      type: "text",
      id: "pending_text",
      label: "shop:section.order.pendingText",
      default: "shop:storefront.order.pending",
    },
    {
      type: "text",
      id: "shipping_label",
      label: "shop:section.order.shippingLabel",
      default: "shop:storefront.order.shipping",
    },
    {
      type: "text",
      id: "tax_label",
      label: "shop:section.order.taxLabel",
      default: "shop:storefront.order.tax",
    },
    {
      type: "text",
      id: "discount_label",
    ...
    },
    {
      ...
      default: "shop:storefront.order.total",
    },
    {
      type: "text",
      id: "tracking_label",
      label: "shop:section.order.trackingLabel",
      default: "shop:storefront.order.tracking",
    },
    {
      type: "text",
      id: "note_label",
      label: "shop:section.order.noteLabel",
      default: "shop:storefront.order.note",
    },
...
export const orderListSection: SectionDefinition = {
  ...
  settings: [
    ...headingSettings(),
    {
      ...
      default: "shop:storefront.orders.empty",
    },
    {
      type: "text",
      id: "number_label",
      label: "shop:section.orderList.numberLabel",
      default: "shop:storefront.orders.number",
    },
    {
      type: "text",
      id: "status_label",
