...
export const EVENTS_SERVER_I18N: ServerI18nBundle = {
  ...
  messages: {
    "zh-CN": {
      ...
      "events.signal_not_found": "这条来源不存在或已被移除",
      ...
      "events.topics_required": "至少启用一个主题",
      ...
      "events.audit.signal_removed": "移除事件信号：{{signal}}",
      "events.audit.topics_updated": "更新显示主题",
      "events.list.all": "全部事件",
      "events.list.sourceLabel": "事件雷达",
      "events.list.currentTopic": "当前主题（按页面自动）",
      "events.list.allDescription": "本站追踪的所有事件",
      "events.topic.ai": "AI",
      "events.topic.tech": "科技",
      "events.topic.business": "商业",
      "events.topic.world": "国际",
      "events.topic.gaming": "游戏",
      "events.topic.entertainment": "娱乐",
      "events.topic.sports": "体育",
    ...
    en: {
      ...
      "events.signal_not_found": "That source is gone or already removed",
      ...
      "events.feed_name_too_long":
        "Source name cannot exceed {{max}} characters",
      ...
      "events.topics_required": "Keep at least one topic enabled",
      ...
      "events.audit.signal_removed": "Removed event signal: {{signal}}",
      "events.audit.topics_updated": "Updated visible topics",
      "events.list.all": "All events",
      "events.list.sourceLabel": "Event radar",
      "events.list.currentTopic": "Current topic (follows the page)",
      "events.list.allDescription": "Everything this site tracks",
      "events.topic.ai": "AI",
      "events.topic.tech": "Tech",
      "events.topic.business": "Business",
      "events.topic.world": "World",
      "events.topic.gaming": "Gaming",
      "events.topic.entertainment": "Entertainment",
      "events.topic.sports": "Sports",
