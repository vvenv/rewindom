...
import { optionsFromLabels } from "@rewindom/module-sdk/client";
import { hasActiveFilters } from "@rewindom/module-sdk/client";
import { getLocaleNativeLabel, type AppLocale } from "@rewindom/module-sdk/client";
import { useTranslation } from "react-i18next";

import { categoryLabelMap, type SiteDocCategory  } from "../../shared/site-doc-category.js";
...
export function SiteDocFilters({
  ...
  categoryCatalog: readonly SiteDocCategory[];
