...
import { DEFAULT_LOCALE, type AppLocale } from "@rewindom/module-sdk/client";
...
export function formFromFullDoc(fullDoc: SiteDoc): DocFormState {
  return {
    slug: fullDoc.slug,
